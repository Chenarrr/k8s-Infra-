...
|-----------|-----------|----------|
| Backend | `GET /api/notes` (5s delay, 10s interval) | `GET /api/notes` (15s delay, 30s interval) |
| Frontend | `GET /` (5s delay, 10s interval) | `GET /` (10s delay, 30s interval) |
| MongoDB | `mongosh db.adminCommand('ping')` (10s delay) | same (30s delay) |
