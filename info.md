...
- **Bitnami readme-generator-for-helm** - Helm chart documentation generator (creates `README.md` at project root)
...
├── README.md                   # Auto-generated by Bitnami readme-generator-for-helm
├── charts/notes-app/
...
# Install Bitnami readme-generator-for-helm documentation generator
npm install --global github:bitnami/readme-generator-for-helm
```
...
✅ **Minimal values.yaml** - Clean configuration with structured metadata comments  
✅ **Essential values only** - Just the parameters you need to configure  
✅ **Easy to read** - Simple, straightforward YAML structure  
✅ **Auto-generated docs** - Comprehensive documentation via Bitnami readme-generator-for-helm  
✅ **Faster maintenance** - One metadata source in `values.yaml`

Focuses on simplicity and clean configuration files while still providing automated documentation generation.

### 🔥 **Advanced Documentation with Bitnami readme-generator-for-helm**

**What is Bitnami readme-generator-for-helm?**
Bitnami readme-generator-for-helm is a tool for automatically generating markdown documentation from Helm chart values metadata. It reads `values.yaml` tags like `## @param`, then updates the README parameter section.

**How Bitnami readme-generator-for-helm Works:**
- 🔍 **Metadata-Driven** - Reads `## @param` tags in values.yaml
- 🧠 **Path-Aware** - Uses full parameter key paths like `backend.image.tag`
- ⚙️ **Configurable** - Uses JSON config for section titles and behavior
- ⚡ **Zero Manual Work** - Completely automated documentation generation

**Bitnami readme-generator-for-helm Features:**
- Auto-generated values table with types and defaults
- Parameter grouping with sections and metadata tags
- JSON-based generator configuration
- CI-friendly execution via npm install

**What Bitnami readme-generator-for-helm Generates:**
- Complete parameter table with types, defaults, and descriptions
- Updated README values section from values metadata
...
- **Steps:**
  ...
  6. Install Bitnami readme-generator-for-helm  
  7. Generate documentation (`make docs`)
...
- **Bitnami readme-generator-for-helm** (Helm chart documentation generator)
...
make docs     # Generate README.md (Bitnami readme-generator-for-helm)
