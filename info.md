...
> - ✅ Auto-generated documentation with readmeai
...
| **Documentation** | ✅ Current | Auto-generated with readmeai |
...
- **readmeai** - AI-powered README generator (creates root README.md)
...
├── README.md                   # Auto-generated by readmeai
├── charts/notes-app/
...
# Install readmeai documentation generator
pipx install readmeai --python python3.13
```
...
✅ **Auto-generated docs** - Comprehensive documentation via readmeai  
...
### 🔥 **Advanced Documentation with readmeai**

**What is readmeai?**
readmeai is an AI-powered README generator that analyzes your entire repository structure and produces comprehensive, professional documentation. It uses LLMs (local via Ollama or cloud APIs) to understand your codebase and generate contextual descriptions.

**How readmeai Works:**
- 🔍 **Deep Analysis** - Scans all files, directories, and configurations
- 🧠 **AI-Powered** - Uses LLMs to generate contextual descriptions
- 🏗️ **Multi-Language** - Understands Helm charts, YAML, Makefiles, and more
- ⚡ **Zero Manual Work** - Completely automated documentation generation

**readmeai Features:**
- Project structure visualization with configurable tree depth
- Badge generation (flat-square, shields.io)
- Accordion-style navigation
- Customizable themes and styling
- Offline mode for CI environments

**What readmeai Generates:**
- Complete project overview with AI-generated descriptions
- File-by-file summaries of the entire repository
- Getting started guide with install/usage/test instructions
...
- **readmeai v0.6.3** (AI-powered README generator via pipx)
...
make docs     # Generate README.md (readmeai)
