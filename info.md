...
> - ✅ Auto-generated documentation with helm-docs
...
| **Documentation** | ✅ Current | Auto-generated with helm-docs |
...
- **helm-docs** - Helm chart documentation generator (creates charts/notes-app/README.md)
...
# Install helm-docs documentation generator
...
✅ **Auto-generated docs** - Comprehensive documentation via helm-docs  
...
### 🔥 **Advanced Documentation with helm-docs**

**What is helm-docs?**
helm-docs is a tool for automatically generating markdown documentation from Helm charts. It reads `Chart.yaml`, `values.yaml` (with `# --` comments), and optional `.gotmpl` templates to produce professional chart README files.

**How helm-docs Works:**
- 🔍 **Deep Analysis** - Reads Chart.yaml, values.yaml, and template files
- 🧠 **Comment-Driven** - Uses `# --` comments in values.yaml for descriptions
- 🏗️ **Template System** - Go templates for customizable output
- ⚡ **Zero Manual Work** - Completely automated documentation generation

**helm-docs Features:**
- Auto-generated values table with types and defaults
- Chart metadata (version, appVersion, description)
- Go template customization via `.gotmpl` files
- Recursive chart directory scanning
- CI-friendly (single binary, no dependencies)

**What helm-docs Generates:**
- Complete parameter table with types, defaults, and descriptions
- Chart metadata section
- Requirements/dependencies table
- Custom sections via Go templates
...
- **helm-docs v1.14.2** (Helm chart documentation generator)
